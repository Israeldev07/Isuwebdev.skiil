name: isu
description: Skill para desarrollo frontend estático de alta gama (estilo visual japonés contemporáneo) y backend relacional tolerante a fallos.
---
...
* **Core:** Next.js (Framework basado en React)
* **Renderizado:** Server-Side Rendering (SSR) / Static Site Generation (SSG) para optimización SEO en motores de búsqueda.
